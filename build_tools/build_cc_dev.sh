...
# Only builds the cc-opt and other developtment relevant targets
# Other available targets are: cc-translate mlir-runner check-cc
# CCPythonModules
cmake --build "$MY_BUILD_DIR" --target standalone-opt 